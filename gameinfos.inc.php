...
$gameinfos = [
    ...
    "game_name" => "Age of Comics: The Golden Years",
    ...
    "publisher_website" => "http://www.liriusgames.com/",

    // Board Game Geek ID of the publisher
    "publisher_bgg_id" => 50155,
    ...
    "presentation" => [
        totranslate(
            "Age of Comics: The Golden Years is a worker placement game in which players run a publishing company during the golden age of comics (circa 1938-54)."
        ),
        totranslate(
            "To become the top comic book publisher, players need to build their fan base by hiring the right artists and writers, publishing comics, and sending their sales agents across Manhattan's newsstands to grab the best sales orders."
        ),
    ],
